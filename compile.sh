...
javac -d ./build -cp lib/jarchivelib-0.7.1-jar-with-dependencies.jar:lib/json-simple-1.1.1.jar:lib/pecoff4j-0.4.0.jar:lib/semver4j-5.1.0.jar -source 1.8 -target 1.8 ./src/*.java ./src/Setting/*.java
echo "-----------------------------------------------------------"
