...
public class InstallFiles {
    ...
    public static String[] kfxMusicFiles = {
            "music" + File.separator + "keeper02.ogg",
            "music" + File.separator + "keeper03.ogg",
            "music" + File.separator + "keeper04.ogg",
            "music" + File.separator + "keeper05.ogg",
            "music" + File.separator + "keeper06.ogg",
            "music" + File.separator + "keeper07.ogg",
    };
}
